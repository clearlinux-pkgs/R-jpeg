...
Version  : 0.1.11
Release  : 55
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/jpeg_0.1-11.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/jpeg_0.1-11.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742763807
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/jpeg/libs/jpeg.so
/V4/usr/lib64/R/library/jpeg/libs/jpeg.so
